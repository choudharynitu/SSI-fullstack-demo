...
import { IDIDManager, IKeyManager, IDataStore, IDataStoreORM, IResolver, ICredentialPlugin } from '@veramo/core';
...
import { Cheqd, CheqdDIDProvider } from '@cheqd/did-provider-cheqd';
